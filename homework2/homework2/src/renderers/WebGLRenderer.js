        ...
        for (let l = 0; l < this.lights.length; l++) {
            ...
            for (let i = 0; i < this.meshes.length; i++) {
                ...
                for (let k in this.meshes[i].material.uniforms) {
                    ...
                    let rotated = getRotationPrecomputeL([
                        precomputeLR[guiParams.envmapId],
                        precomputeLG[guiParams.envmapId],
                        precomputeLB[guiParams.envmapId],
                    ], cameraModelMatrix);
                    rotatedPrecomputeLR[guiParams.envmapId] = rotated[0];
                    rotatedPrecomputeLG[guiParams.envmapId] = rotated[1];
                    rotatedPrecomputeLB[guiParams.envmapId] = rotated[2];
